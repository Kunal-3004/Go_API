...
import (
	...
	"github.com/Kunal-3004/google-test-to-speech/speech"
)
...
func (cli *CLI) Run(args []string) int {
	...
	flags.StringVar(&out, "o", "", "output audio file (suport format of the audio: LINEAR16,MP3)")
...
func makeSpeechOpt(text, voice, out string, rate, pitch float64) (*speech.SpeechOptions, error) {
	...
	if 0.25 > rate || rate > 4.0 {
		return nil, fmt.Errorf("valid speaking rate is between 0.25 and 4.0 (rate:%g)", rate)
	}
